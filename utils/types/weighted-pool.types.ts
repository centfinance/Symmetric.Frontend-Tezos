...
type Methods = {
  ...
  approve: (spender: address, value: nat) => Promise<void>;
  initializePool: () => Promise<void>;
  set_paused: (param: boolean) => Promise<void>;
  transfer: (from: address, to: address, value: nat) => Promise<void>;
...
type MethodsObject = {
  ...
  approve: (params: { spender: address; value: nat }) => Promise<void>;
  initializePool: () => Promise<void>;
  set_paused: (param: boolean) => Promise<void>;
  transfer: (params: {
    from: address;
...
type contractTypes = {
  ...
  storage: Storage;
  code: { __type: "WeightedPoolCode"; protocol: string; code: object[] };
};
export type WeightedPoolContractType =
  ContractAbstractionFromContractType<contractTypes>;
export type WeightedPoolWalletType =
